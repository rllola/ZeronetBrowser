...
a = Analysis(['launch.py'],
             ...
             binaries=[],
             datas=[],
             hiddenimports=['gevent', 'ConfigParser', 'json', 'sqlite3', 'msgpack', 'setuptools', 'cgi', 'xml.dom', 'posixpath', 'logging.handlers', 'argparse', 'enum', 'pypiwin32'],
             #hiddenimports=[],
             hookspath=[],
             runtime_hooks=[],
             excludes=['ZeroNet'],
...
if platform.startswith("darwin"):
  datas += [('qt.conf', 'qt-osx.conf', 'DATA')]
