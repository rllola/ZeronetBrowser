...
a = Analysis(['launch.py'],
             ...
             binaries=[],
             datas=[],
             hiddenimports=['gevent', 'configparser', 'json', 'sqlite3', 'msgpack', 'setuptools', 'cgi', 'xml.dom', 'posixpath', 'logging.handlers', 'argparse', 'enum', 'pypiwin32', 'socks', 'bencode', 'sockshandler', 'geventwebsocket', 'merkletools', 'coincurve', 'bitcoin', 'base58', 'bitcoin.signmessage'],
             #hiddenimports=[],
             hookspath=[],
             runtime_hooks=[],
             excludes=['ZeroNet'],
